...
def generate_image_url(prompt):
    ...
    enhanced_prompt = f"masterpiece, best quality, highly detailed, beautiful, {prompt}"
    seed = random.randint(1, 999999)
    return f"https://image.pollinations.ai/prompt/{enhanced_prompt.replace(' ', '%20')}?width=1024&height=1024&nologo=true&seed={seed}"
